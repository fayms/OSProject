...
2. What are the two options of ram, disk and vcpu configuration you can have in running codespaces . ***(1 mark)*** 
  1. 2-Core CPU, 8GB RAM and 32GB storage.
  2. 4-Core CPU, 16GB RAM and 32GB storage.
...
overlay         32847680 10349416  20804168  34% /
tmpfs              65536        0     65536   0% /dev
shm                65536        8     65528   1% /dev/shm
/dev/root       30298176 24240296   6041496  81% /vscode
/dev/sdb1       46127956       68  43752312   1% /tmp
/dev/loop3      32847680 10349416  20804168  34% /workspaces
```
...
Mem:          7.7Gi       1.1Gi       366Mi        64Mi       6.3Gi       6.3Gi
Swap:            0B          0B          0B
```
